...
EnemyFlower::EnemyFlower()
{
    ...
    bodySize = CCSizeMake(80.0f, 80.0f);
    enemyBody = Sprite::create("image/enemy/flower0.png", CCRectMake(0, 0, 80, 80));
    enemyBody->setAnchorPoint(Point(0, 0));
    this->setContentSize(bodySize);
    this->addChild(enemyBody);
    this->setAnchorPoint(Point(0.5f, 0));
    ...
    // 吃人花虽然不会被踩死，但是会被子弹打死
    enemyLifeOver = SpriteFrame::create("image/enemy/flower0.png", CCRectMake(0, 0, 80, 80));
    enemyLifeOver->retain();
...
EnemyTortoise::EnemyTortoise(int _startface)
{
    ...
    case 0:
        startFace = eLeft;
        enemyBody = Sprite::create("image/enemy/tortoise0.png", CCRectMake(0, 0, 80, 80));
        leftFace = SpriteFrame::create("image/enemy/tortoise0.png", CCRectMake(0, 0, 80, 80));
        leftFace->retain();
        moveOffset = -ccMoveOffset;
        break;
    case 1:
        startFace = eRight;
        enemyBody = Sprite::create("image/enemy/tortoise0.png", CCRectMake(320, 0, 80, 80));
        rightFace = SpriteFrame::create("image/enemy/tortoise0.png", CCRectMake(320, 0, 80, 80));
        rightFace->retain();
        moveOffset = ccMoveOffset;
        break;
    default:
    ...
    enemyLifeOver = SpriteFrame::create("image/enemy/tortoise0.png", CCRectMake(0, 0, 80, 80));
    enemyLifeOver->retain();

    overByArrow = SpriteFrame::create("image/enemy/tortoise0.png", CCRectMake(0, 0, 80, 80));
    overByArrow->retain();
}
...
EnemyTortoiseRound::EnemyTortoiseRound(float dis)
{
    ...
    bodySize = CCSizeMake(80.0f, 80.0f);
    enemyBody = Sprite::create("image/enemy/tortoise0.png", CCRectMake(80, 0, 80, 80));
    enemyBody->setAnchorPoint(Point(0, 0));
    this->setContentSize(bodySize);
    this->addChild(enemyBody);
    this->setAnchorPoint(Point(0.5f, 0.0f));
